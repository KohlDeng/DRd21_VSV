...
struct Param {
  ...
  // For Pure Pursuit
  double desire_mpc_vel;
  double desire_pp_vel;
  double desire_vel;
  ...
  void getParams(ros::NodeHandle &nh) {
    ...
    desire_mpc_vel = nh.param("weight/desire_mpc_vel", 15);
    desire_pp_vel = nh.param("desire_pp_vel", 3);
    desire_vel = desire_pp_vel;  //initialize
  }
};
